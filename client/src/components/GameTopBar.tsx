 ...
 * La phase et l'état de la barrière vivent dans le PhaseTracker ; le meneur est un badge
 * sur sa plaque de siège ; le pense-bête se commande par sa poignée au bord droit
 * (QoL §3 — source unique, l'ancien bouton de barre a disparu).
 */
